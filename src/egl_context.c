...
GLFWbool _glfwInitEGL(void)
{
    ...
    if (_glfw.egl.EXT_client_extensions)
    {
        ...
        _glfw.egl.KHR_platform_x11 =
            _glfwStringInExtensionString("EGL_KHR_platform_x11", extensions);
        _glfw.egl.EXT_platform_wayland =
            _glfwStringInExtensionString("EGL_EXT_platform_wayland", extensions);
        _glfw.egl.KHR_platform_wayland =
            _glfwStringInExtensionString("EGL_KHR_platform_wayland", extensions);
    }
