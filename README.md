...
GLFW bundles a number of dependencies in the `deps/` directory.
 ...
 - [NanoVG](https://github.com/memononen/nanovg) for API-agnostic test rendering
 - [fontstash](https://github.com/memononen/fontstash),
   [stb\_image](http://nothings.org/) and [stb\_truetype](http://nothings.org/)
   as dependencies for NanoVG


## Changelog

 - Added NanoVG for API-agnostic test rendering
